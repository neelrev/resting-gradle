...
public final class Resting {
	...
	public final static ServiceResponse put(String baseURI, int port,String messageToPost,List<Header> headers, EncodingTypes encoding){
		return PutHelper.put(baseURI,port, messageToPost, encoding,headers,null);
	}//put
